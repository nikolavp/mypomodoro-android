...
public class TodoSheetActivity extends PomodoroActivity {
	/**
	 * TODO: Test data that should be removed.
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spec.setContent(R.id.todosheet);
		host.addTab(spec);

		spec = host.newTabSpec("urgent");
		spec.setIndicator(getString(R.string.urgent));
		spec.setContent(R.id.urgent);
		host.addTab(spec);

		spec = host.newTabSpec("activities");
		spec.setIndicator(getString(R.string.activities));
		spec.setContent(R.id.activities);
		host.addTab(spec);
	}

	private void initTodoSheet() {
		ListView list = (ListView) findViewById(R.id.todosheet);
